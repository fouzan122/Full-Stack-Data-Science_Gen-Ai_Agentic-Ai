...
import pickle
import numpy as np
model = pickle.load(open(r'C:\Users\fouza\OneDrive\Desktop\Data science nit\machine learning\linear_regression_model.pkl', 'rb'))
st.title("Salary Prediction App Created By Fouzan Khan")
...
if st.button("Predicted Salary"):
    ...
    st.write("The model was trained using a dataset of salaries and years of experience.built model by fouzan khan")